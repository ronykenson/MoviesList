package com.example.bradson.movieslist;
...
public class Flicks_Activity extends AppCompatActivity {
    //constants
    ...
    public final static String TAG = "Flicks_Activity";
    // Instant field
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flicks_);
        ...
        client.get(url, params, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    // get the poster size
                    JSONArray posterSizeOption = images.getJSONArray("poster_size");
